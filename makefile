CC = g++
OBJECTS = main.o shader.o glad/glad.o planet.o universe.o camera.o ship.o arrow.o
...
ship.o: src/ship.cpp
	$(CC) -c src/ship.cpp -Iglad/include -Iinclude
arrow.o: src/arrow.cpp
	$(CC) -c src/arrow.cpp -Iglad/include -Iinclude
